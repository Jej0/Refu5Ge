...
# -------------------------------------------------------------------
# Décorateur personnalisé (remplace l'ancien @group_required)
# -------------------------------------------------------------------
def manager_required(view_func):
    ...
    def wrapper(request, *args, **kwargs):
        ...
        # Vérifie que l'utilisateur a le niveau 'manager'
...
# -------------------------------------------------------------------
# Formset pour les attributs dynamiques
# -------------------------------------------------------------------
...
class RoomDetail(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Essaye d'importer la fonction de rapports (si elle existe)
        try:
            from rapports.views import get_monthly_device_report
            context["monthly_report"] = get_monthly_device_report(self.object)
        except ImportError:
            # Si la fonction n'existe pas encore, on passe un dictionnaire vide
